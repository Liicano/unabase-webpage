  ...
  <div style="heigth: 100vh;">
    <v-container>
      <div class="principalContainer md-layout" style="heigth: 100vh !important;">
        <div
          class="md-layout-item md-medium-size-50 md-small-size-100 md-large-size-45 md-xlarge-size-55 pull-right text-right"
        >
          <v-card
          ...
          >
            ...
            <v-card-actions style="z-index:1000 !important; margin-top: 2%;">
              <v-btn
                ...
                flat
                x-large
                class="black--text font-weight-black display-2"
        ...
        <v-spacer></v-spacer>
        <div
          class="md-layout-item md-medium-size-50 md-small-size-100 md-large-size-45 md-xlarge-size-35 pull-left"
